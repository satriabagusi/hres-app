...
export interface PinturaImageState {
    ...
    backgroundFilterMode?: undefined | 'none' | 'image';
...
export interface PinturaEditorImageOptions {
    ...
    imageBackgroundFilterMode?: 'none' | 'image';
...
export type SelectionShapes = SelectionRectangle | SelectionPath | SelectionEllipse;
